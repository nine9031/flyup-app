    ...
    return (
        <section id="home" className="relative pt-32 pb-20 overflow-hidden bg-white scroll-mt-20">
            ...
            <div className="container flex flex-col items-center text-center">
                ...
                {/* Headline */}
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-slate-900 tracking-tight leading-[1.15] mb-8 max-w-4xl">
                    เปลี่ยนไอเดียคุณ <br className="hidden sm:block" />
                    <span className="text-blue-600">ให้กลายเป็นธุรกิจจริง</span>
                </h1>

                {/* Subheadline */}
                <p className="text-lg sm:text-xl text-slate-500 max-w-2xl mx-auto mb-12 leading-[1.8] font-light">
